...
class ConstrainedEPCAgent(agents.robust.robust_epc.RobustEPCAgent):
    ...
    def default_config(cls):
        ...
        cfg.update({"noise_bound": 1, "perturbation_bound": 1, "update_frequency": 1})
        return cfg
    ...
    def polytope(self):
        # nominal matrix A0, list of vertices dA, such that A(theta) = A0 + alpha^T dA.
    ...
    def robustify_env(self):
        ...
        robust_env = common.factory.safe_deepcopy_env(self.env)
