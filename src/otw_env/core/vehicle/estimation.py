...
from otw_env.road.road import Road, LaneIndex, Route
from otw_env.common.utils import confidence_polytope, is_consistent_dataset, Vector
from controller import LinearVehicle
from otw_env.vehicle.prediction import IntervalVehicle, Polytope
...
class RegressionVehicle(IntervalVehicle):
    ...
    def polytope_from_estimation(self, data: dict, parameter_box: np.ndarray, structure: Callable[[], Polytope])-> Polytope:
        if not data:
