...
from otw_env.common.observation import MultiAgentObservation, observation_factory
from otw_env.road.lane import StraightLane, LineType
from otw_env.road.road import Road, RoadNetwork
# from OTW.vehicle.graphics import VehicleGraphics
from otw_env.vehicle.kinematics import Vehicle
from otw_env.vehicle.objects import Landmark, Obstacle
...
register(
    id='park-v1',
    entry_point='OTW.envs:ParkingEnv',
)

# register(
#     id='parking-ActionRepeat-v1',
#     entry_point='OTW.envs:ParkingEnvActionRepeat'
# )

# register(
#     id='parking-parked-v1',
#     entry_point='OTW.envs:ParkingEnvParkedVehicles'
# )
