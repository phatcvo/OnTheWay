...
from otw_env.envs.common.finite_mdp import compute_ttc_grid
from otw_env.envs.common.graphics import EnvViewer
from otw_env.core.road.lane import AbstractLane
from otw_env.utils.utils import Vector
from otw_env.core.vehicle.kinematics import Vehicle


if TYPE_CHECKING:
    from otw_env.envs.common.abstract import AbstractEnv
...
class ObservationType:
    ...
    def observer_vehicle(self):
        vehicle = self.__observer_vehicle
        if vehicle is None:
